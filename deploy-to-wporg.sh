...
# main config
PLUGINSLUG="allow-javascript-in-text-widgets"
CURRENTDIR=`pwd`
MAINFILE="allow-javascript-in-text-widgets.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/allow-javascript-in-text-widgets/" # Remote SVN repo on wordpress.org, with trailing slash
